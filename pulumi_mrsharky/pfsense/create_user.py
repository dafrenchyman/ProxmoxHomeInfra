...
@pulumi.input_type
class PfsenseCreateUserArgs(object):
    ...
    def __init__(
        ...
        if username is None:
            raise Exception(f"{self.__class__.__name__}: username cannot be None")
...
class PfsenseCreateUserProvider(ResourceProviderPfsense):
    def _process_inputs(self, props) -> PfsenseCreateUserArgs:
        pf_sense_api_connection_args = super()._process_inputs(props)

        arguments = PfsenseCreateUserArgs(
    ...
    def create(self, props: Any) -> CreateResult:
        ...
        print(f"Creating username: {arguments.username}")
        api.create_user(
    ...
    def delete(self, id: str, props: Any) -> CreateResult:
        ...
        api.delete_user(arguments.username)
...
class PfsenseCreateUser(Resource):
    test: Output[str]
    ...
    def __init__(
        self,
        resource_name,
        create_user_args: PfsenseCreateUserArgs,
        opts: Optional[ResourceOptions] = None,
    ):
        full_args = {"test": None, **vars(create_user_args)}
        super().__init__(PfsenseCreateUserProvider(), resource_name, full_args, opts)
